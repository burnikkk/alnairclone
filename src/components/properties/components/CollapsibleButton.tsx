...
export const CollapsibleButton: React.FC<CollapsibleButtonProps> = ({
  ...
  return (
    <>
      <div className="hidden lg:block border-l border-r w-[32px] z-10 absolute top-0 right-0 bottom-0">
        <button
      ...
      <div className="block lg:hidden fixed bottom-[12px] left-1/2 -translate-1/2 z-50">
        <button
          onClick={() => setIsCollapsed(!isCollapsed)}
