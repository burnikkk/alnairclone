...
export const BtnSelectHouse: React.FC<SelectProps> = ({ className, onChange }) => {
  const { houseType, setHouseType } = useHouseType();
  ...
  return (
    <Select value={houseType} onValueChange={handleChange}>
      ...
      <SelectContent className="max-h-60 w-55">
        <SelectItem onClick={resetFilter} value="all">Тип жилья</SelectItem>
